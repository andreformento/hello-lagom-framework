 ...
 * consume the HellolagomframeworkStreamService service.
 */
public interface HellolagomframeworkStreamService extends Service {
    /**
    ...
    default Descriptor descriptor() {
        return named("hello-lagom-framework-stream")
                .withCalls(
