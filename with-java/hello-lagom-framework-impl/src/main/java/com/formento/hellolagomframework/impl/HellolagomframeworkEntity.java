...
/**
 * This is an event sourced entity. It has a state, {@link HellolagomframeworkState}, which
 ...
 */
public class HellolagomframeworkEntity extends PersistentEntity<HellolagomframeworkCommand, HellolagomframeworkEvent, HellolagomframeworkState> {
    /**
     * An entity can define different behaviours for different states, but it will
     * always start with an initial behaviour. This entity only has one behaviour.
     */
    @Override
    public Behavior initialBehavior(Optional<HellolagomframeworkState> snapshotState) {
        /*
        ...
        BehaviorBuilder b = newBehaviorBuilder(
                snapshotState.orElse(new HellolagomframeworkState("Hello", LocalDateTime.now().toString()))
        );
        ...
        b.setEventHandler(GreetingMessageChanged.class,
                ...
                // the event.
                evt -> new HellolagomframeworkState(evt.message, LocalDateTime.now().toString())
        );
