 ...
 */
public interface HellolagomframeworkEvent extends Jsonable, AggregateEvent<HellolagomframeworkEvent> {
    /**
     ...
     * events.
     */
    AggregateEventShards<HellolagomframeworkEvent> TAG = AggregateEventTag.sharded(HellolagomframeworkEvent.class, 4);
    ...
    @Override
    default AggregateEventTagger<HellolagomframeworkEvent> aggregateTag() {
        return TAG;
    }
}
