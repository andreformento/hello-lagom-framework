...
/**
  * The hello-lagom-framework service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HellolagomframeworkService.
  */
trait HellolagomframeworkService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("hello-lagom-framework")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(HellolagomframeworkService.TOPIC_NAME, greetingsTopic)
